...
public class DepartmentController {
    ...
    @PostMapping
    public ResponseEntity<DepartmentResponseDto> departmentCreation(@RequestBody DepartmentRequestDto department){
    ...
    @PutMapping("/{depId}")
    public ResponseEntity<DepartmentResponseDto> updateDepartment(@PathVariable String depId,@RequestBody DepartmentRequestDto department){
